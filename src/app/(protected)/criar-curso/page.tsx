...
export default function CriarCursoPage() {
  ...
  const onFinish = async (values: any) => {
    ...
    const courseData = {
      ...
      campusId: 1,
      // ALTERADO: O valor agora é fixo como 'false'.
      visivel: false,
    };
    ...
    try {
      ...
      if (response.ok) {
        ...
        message.success("Curso criado com sucesso como privado!");
        router.push(`/cursos/${newCourse.id}`);
      } else {
  ...
  return (
    <div className={styles.container}>
      ...
      >
        <Row gutter={24}>
          <Col xs={24} md={18}> {/* Aumentado para ocupar mais espaço */}
          ...
          {/* O campo de visibilidade foi removido daqui */}
          <Col xs={24} md={6}>
